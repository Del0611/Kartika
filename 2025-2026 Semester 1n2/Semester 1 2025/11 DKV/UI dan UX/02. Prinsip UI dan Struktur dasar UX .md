...
> 💡 **Intisari:** Desain yang indah tidak akan berguna jika pengguna bingung saat menggunakannya. Di sinilah prinsip dasar **UI (User Interface)** dan **UX (User Experience)** bermain untuk memastikan produk digital Anda mudah, nyaman, dan inklusif.
...
*   **Contoh Penerapan:** 
    *   Tombol berubah warna saat diarahkan oleh mouse (*hover state*).
    *   Muncul ikon melingkar (*loading spinner*) saat data sedang dikirim.
    *   Muncul notifikasi sukses berwarna hijau ketika berhasil menyimpan data.

---

## 6. Simplicity & Minimalis (Hick's Law)

> 📌 **Hick’s Law:** Semakin banyak pilihan yang diberikan kepada pengguna, semakin lama waktu yang mereka butuhkan untuk mengambil keputusan.
...
| Komponen | Fokus Utama | Contoh Elemen |
| :--- | :--- | :--- |
| **UI (User Interface)** | "Bagaimana tampilannya terlihat menarik dan rapi" | Visual Hierarchy, Consistency, Warna, Tata Letak |
| **UX (User Experience)** | "Bagaimana rasanya saat digunakan oleh pengguna" | Usability, Accessibility, Feedback, Alur Pengguna |

Keduanya harus berjalan beriringan untuk menciptakan produk digital yang sukses dan dicintai oleh pengguna.
